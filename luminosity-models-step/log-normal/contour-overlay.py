...
n_contours = plt.contour(xVals, yVals, numAboveThreshold, TOTAL_FGL_NUMBER * np.array(PERCENTAGES), colors=[LINE_COLOR], linewidths=[1])
...
# Observation
shade(numAboveThreshold, TOTAL_FGL_NUMBER * PERCENTAGES[0], xVals, yVals)
