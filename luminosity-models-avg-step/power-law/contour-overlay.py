...
n_contours = plt.contour(lMaxVals, lMinVals, numAboveThreshold,  np.array(PERCENTAGES) * TOTAL_FGL_NUMBER, colors=[LINE_COLOR], linewidths=[1])
...
# Observation
shade(numAboveThreshold, PERCENTAGES[0] * TOTAL_FGL_NUMBER, lMaxVals, lMinVals)
