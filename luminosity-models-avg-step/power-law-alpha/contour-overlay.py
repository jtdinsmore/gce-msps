...
n_contours = plt.contour(alphaVals, lMaxVals, numAboveThreshold, np.array(PERCENTAGES) * TOTAL_FGL_NUMBER, linewidths=[1], colors=[LINE_COLOR])
...
r_contours = plt.contour(alphaVals, lMaxVals, fracAboveThreshold, FRACS_ABOVE_THRESHOLD, colors=[LINE_COLOR], linewidths=[1], linestyles='dashed')
...
# Observation
shade(numAboveThreshold, PERCENTAGES[0] * TOTAL_FGL_NUMBER, alphaVals, lMaxVals)
