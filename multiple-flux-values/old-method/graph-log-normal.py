...
plt.contour(xVals, yVals, numSeen, NUM_PULSARS_ABOVE_THRESHOLD * FLUX_QUOT, colors='k', linestyles="solid", linewidths=1)
plt.contour(xVals, yVals, lumSeen, FRAC_ABOVE_THRESHOLD * FLUX_QUOT, colors='k', linestyles="dashed", linewidths=1)
