...
FLUX_QUOT = np.asarray([0, 1/3, 1/2, 1, 2, 3, 4, 5, 100])
...
plt.contourf(alphaVals, lMaxVals, numSeen, NUM_PULSARS_ABOVE_THRESHOLD * FLUX_QUOT, colors=COLORS_NUM, alpha=0.4)
plt.contourf(alphaVals, lMaxVals, lumSeen, FRAC_ABOVE_THRESHOLD * FLUX_QUOT, colors=COLORS_FRAC, alpha=0.5)

plt.contour(alphaVals, lMaxVals, numSeen, NUM_PULSARS_ABOVE_THRESHOLD * FLUX_QUOT, colors='k', linestyles="solid", linewidths=1)
plt.contour(alphaVals, lMaxVals, lumSeen, FRAC_ABOVE_THRESHOLD * FLUX_QUOT, colors='k', linestyles="dashed", linewidths=1)
